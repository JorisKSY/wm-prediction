...
EXPERIMENT_RUN_ID = "poisson_v1_vs_cleaned14_alpha1_2026_06_06"
                ...
                rows.append(
                    {
                        ...
                        "notes": (
                            "Initial Phase A experiment-store smoke run. "
                            "Compares current MVP 18-feature set with cleaned 14-feature candidate."
                        ),
                    }
                )
